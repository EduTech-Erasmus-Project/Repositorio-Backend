    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_file', models.FileField(blank=True, null=True, upload_to='sourceFile')),
                ('item_v1', models.CharField(blank=True, max_length=40, null=True)),
                ('item_v2', models.CharField(blank=True, max_length=40, null=True)),
                ('item_t3', models.CharField(blank=True, max_length=40, null=True)),
                ('item_t4', models.CharField(blank=True, max_length=40, null=True)),
                ('item_a5', models.CharField(blank=True, max_length=40, null=True)),
                ('item_i6', models.CharField(blank=True, max_length=40, null=True)),
