...
urlpatterns = [
    ...
    path('api/v1/learning-objects/evaluated-expert-update/<pk>', views.ListLearningObjectExpertQualificationsUpdate.as_view()),
    path('api/v1/learning-objects/evaluated-student/<id>', views.ListLearningObjectEvaluatedByStudent.as_view()),
    path('api/v1/learning-objects/evaluated-expert-qualification/<id>',views.ListLearningObjectEvaluatedByExpertQualifications.as_view()),
    path('api/v1/learning-objects/evaluated-student-qualification/<id>',views.ListLearningObjectEvaluatedByStudentQualification.as_view()),
    path('api/v1/learning-objects/evaluated-student-qualification-results/<user>/<id>',views.ListEvaluatedToStudentRetriveAPIView.as_view()),
    path('api/v1/learning-objects/evaluated-expert-qualification-results/<user>/<id>',views.ListOAEvaluatedToExpertRetriveAPIView.as_view()),
