...
class LearningObjectModelViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            file = ZipFile(serializer.validated_data['file'], 'r')
            ...
            filename_index, filename, url = search_file_index(self.request._current_scheme_host, listNames, folder_area,file_name)
            ...
            print(e)
            print(e.args)
            return Response({"message": "Objetos de Aprendizaje aceptados por el repositorio es IMS y SCORM."},
                            status=HTTP_404_NOT_FOUND)
    ...
    def post(self, request):
        ...
        if len(learning_object) == 1 and learning_object[0].oa_integration_id == None:
            ...
            if is_crete is False:
                ...
                request.data['roa_ref_url']='http://192.168.137.1:4200/#/settings/my-objects'
            ...
            try:
                ...
                with ZipFile(file_path_oa_zip,'r') as zipfile:
