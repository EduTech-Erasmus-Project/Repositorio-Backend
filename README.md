...
- Como generar la estructura de los correos <a href="https://github.com/EduTech-Erasmus-Project/Repositorio-Backend/blob/dev/applications/user/testMail.py">clic aqui.</a>
